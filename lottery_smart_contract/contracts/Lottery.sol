...
contract Lottery is VRFConsumerBase, Ownable
{
    ...
    {
        // minimum 50 dollars
        require(lottery_state == LOTTERY_STATE.OPEN, "Lottery haven't been opened yet");
    ...
    {
        require(lottery_state ==  LOTTERY_STATE.CLOSED, "Lottery has already been started");
    ...
    function endLottery() public onlyOwner
    {
        ...
        // this function call follows request - receive architecture
